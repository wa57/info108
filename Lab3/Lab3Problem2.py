...
def main():
    ...
    #Passes integer into determination functions
    determineAnd(number)
    determineOR(number)
...
#Checks if the input integer is divisible by 5 AND 6 using the logical and operator
...
#Checks if the input integer is divisble by 5 OR 6 using the logical or operator
...
#Helper function using modulo to determine if there is no remainder, therefore completely divisible
